...
export function ArticleCard({ post, featured, className }: { post: Post; featured?: boolean; className?: string }) {
  return (
    <article className={cn("group site-surface relative overflow-hidden rounded-[22px] transition-all duration-240 hover:-translate-y-0.5 hover:shadow-ios-lg", featured && "md:grid md:grid-cols-2 md:gap-0", className)}>
