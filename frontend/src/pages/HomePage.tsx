  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <section className="glass-card mb-10 rounded-ios-lg p-6">
        <h2 className="mb-2 text-lg font-bold text-label-primary">مقالات برگزیده اَتُمیک</h2>
        <p className="text-sm text-label-secondary">
          مقالات تحلیلی و آموزشی در حوزه فیزیک، کیهان‌شناسی، کوانتوم و علم روز. با اَتُمیک همراه باشید.
        </p>
      </section>
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <aside className="space-y-6">
          <div className="glass-card rounded-ios p-5">
            <h3 className="mb-3 text-base font-bold text-label-primary">درباره اَتُمیک</h3>
            <p className="text-sm text-label-secondary">
              اَتُمیک مجله‌ای علمی برای روایت دقیق، ساده و جذاب مفاهیم فیزیک، کیهان‌شناسی، کوانتوم و علم روز است.
            </p>
          </div>
        </aside>
      </div>
