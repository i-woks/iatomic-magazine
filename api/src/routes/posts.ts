...
const postSelect = () => ({ id: posts.id, title: posts.title, slug: posts.slug, excerpt: posts.excerpt, content: posts.content, coverImageId: posts.coverImageId, status: posts.status, authorId: posts.authorId, categoryId: posts.categoryId, readingTime: posts.readingTime, metaTitle: posts.metaTitle, metaDescription: posts.metaDescription, canonicalUrl: posts.canonicalUrl, sources: posts.sources, publishedAt: posts.publishedAt, createdAt: posts.createdAt, updatedAt: posts.updatedAt });
